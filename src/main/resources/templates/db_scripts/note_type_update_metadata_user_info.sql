...
DROP TRIGGER IF EXISTS set_note_type_md_trigger ON note_type CASCADE;

DROP FUNCTION IF EXISTS note_type_set_md();

ALTER TABLE note_type DROP COLUMN IF EXISTS created_by, DROP COLUMN IF EXISTS creation_date;
