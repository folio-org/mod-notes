...
public class PreviousDatabaseMigrationTest extends MigrationTestBase {

  @Sql(
    executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
    scripts = "/migration/schema-v2-13.sql",
    config = @SqlConfig(separator = ScriptUtils.EOF_STATEMENT_SEPARATOR)
  )
  @Test
  void testMigrationOnPreviousVersionDatabase() throws LiquibaseException {
